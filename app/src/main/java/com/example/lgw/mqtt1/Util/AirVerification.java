...
import com.example.lgw.mqtt1.Activity.TVBrandActivity;
...
public class AirVerification extends AppCompatActivity {
    ...
    AirVerification.MqttConnectThread mqttConnectThread = new AirVerification.MqttConnectThread();//连接服务器任务
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_air_verification);
        init();
    ...
    public void onViewClicked(View view) {
        ...
        String[] t;
        String s;
        Air airControl= new Air();;
        switch (view.getId()) {
            case R.id.iv_back:
                intent.setClass(AirVerification.this,  AirConditioningBrandTypesActivity.class);
            ...
            case R.id.bt_yes:
                ...
                if (dataValue > 1) {
                    intent.setClass(AirVerification.this, AirConditioningRemoteControlActivity.class);
                    startActivity(intent);
                }
                break;
            case R.id.bt_no:
                ...
                count++;
                if(count>1){
                    intent.setClass(AirVerification.this,ErrorActivity.class);
                    startActivity(intent);
                }
                break;
            default:
