...
public class ExtendedTypesAdapter extends BaseAdapter {

    List<BrandTypes> datas;
    public ExtendedTypesAdapter(Context context, int Resid, List<BrandTypes> object) {
    ...
    public void processDate(RecyclerView.ViewHolder viewHolder, int i) {
       ...
       TextView tv_brand= itemView.findViewById(R.id.tv_brand);
        ...
        ImageView iv_tv_select=itemView.findViewById(R.id.iv_tv_select);
        iv_tv_select.setImageResource(datas.get(i).getImgId());
    }
