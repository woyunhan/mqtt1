...
import com.example.lgw.mqtt1.Activity.AirConditioningRemoteControlActivity;
import com.example.lgw.mqtt1.Activity.ErrorActivity;
import com.example.lgw.mqtt1.Activity.FanBrandTypesActivity;
import com.example.lgw.mqtt1.Activity.FanRemoteControlActivity;
...
public class FanVerification extends AppCompatActivity {
    ...
    FanVerification.MqttConnectThread mqttConnectThread = new FanVerification.MqttConnectThread();//连接服务器任务
    MqttMessage msgMessage = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fan_verification);
    ...
    @OnClick({R.id.iv_back, R.id.ib_icon, R.id.bt_yes, R.id.bt_no})
    public void onViewClicked(View view) {
        Intent intent = new Intent();
        switch (view.getId()) {
            case R.id.iv_back:
                intent.setClass(FanVerification.this, FanBrandTypesActivity.class);
            ...
            case R.id.bt_yes:
                ...
                dataValue++;
                if (dataValue > 0) {
                    intent.setClass(FanVerification.this, FanRemoteControlActivity.class);
                    startActivity(intent);
                }
                break;
            case R.id.bt_no:
                ...
                count++;
                if(count>0){
                    intent.setClass(FanVerification.this, ErrorActivity.class);
                    startActivity(intent);
                }
                break;
            default:
