...
public class TVVerification extends AppCompatActivity {
    ...
    TVVerification.MqttConnectThread mqttConnectThread = new TVVerification.MqttConnectThread();//连接服务器任务
    MqttMessage msgMessage = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tv_verification);
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.iv_back:
                intent.setClass(TVVerification.this, TVBrandTypesActivity.class);
            ...
            case R.id.bt_yes:
                ...
                if (dataValue > 1) {
                    intent.setClass(TVVerification.this, TVRemoteControlActivity.class);
                    startActivity(intent);
                }
                break;
            case R.id.bt_no:
                ...
                count++;
                if(count>1){
                    intent.setClass(TVVerification.this,ErrorActivity.class);
                    startActivity(intent);
                }
                break;
            default:
